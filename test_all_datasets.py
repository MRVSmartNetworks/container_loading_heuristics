...
def stats_properties(
    ...
    f.write(
        f"{dataset},{(avg_cost):.2f},{std_cost:.2f},{min_cost},{(avg_cost_ACO):.2f},{std_cost_ACO:.2f},{min_cost_ACO},{avg_t:.2f},{std_t:.2f},{N_ITER}\n"
    )
    f.close()
        ...
        if not ONLY_STATS:
            for i in range(N_ITER):
                ...
                try:
                    ...
                    print(
                        f"\nItems cannot be stored in the proposed trucks for {dataset}.\n"
                    )
